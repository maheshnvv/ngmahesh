            ...
            <div class="libraries-grid">
              <div
                *ngFor="let library of libraries"
                ...
                <div class="npm-stats" *ngIf="library.npmStats">
                  <small>
                    <span class="downloads">📊 {{ library.npmStats.downloads }} downloads</span> •
                    <span class="version">📦 v{{ library.npmStats.version }}</span>
                  </small>
                </div>
                ...
                <div class="library-links">
                  <a [routerLink]="['/demo']" class="btn btn-demo">
                    🔗 Live Demo
                  </a>
            ...
            <div class="footer-section">
              ...
              <ul>
                <li *ngFor="let library of libraries">
                  <a [routerLink]="['/demo']">{{ library.name }}</a>
                </li>
              </ul>
            </div>
            <div class="footer-section">
