...
export class AppModule `,"{"," ","}",""),i(107),l("interface PinObject ","{",`
  ...
  data?: any;
`,"}",""),i(6),l("interface LocationObject ","{",`
  latitude: number;
  longitude: number;
  addressInfo?: AddressInfo;
`,"}",""),i(9),c(["export class MyComponent ","{",`
  pins: PinObject[] = [
    `,"{",`
      title: 'New York',
